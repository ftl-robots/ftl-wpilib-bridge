...
static int handlePtrs[NUM_HANDLES];
...
void ResetCallbacks(JNIEnv* env) {
    ...
    notifyConstBufferCallbackCallback = env->GetMethodID(notifyBufferCallbackCls,
            "callback", "(Ljava/lang/String;Ljava/nio/ByteBuffer;)V");
...
void AllocateCallback(JNIEnv *env,
                      jint index,
                      jobject callback,
                      ...
                      RegisterAllCallbackFunc createCallback)
{
    ...
    createCallback(index, callbackFunc, handleAsVoidPtr, initialNotify);
}

void AllocateChannelCallback(JNIEnv *env,
                             jint index,
                             jint channel,
                             jobject callback,
                             jboolean initialNotify,
                             RegisterChannelCallbackFunc createCallback)
{
    auto callbackStore = std::make_shared<CallbackStore>();
...
void AllocateConstBufferCallback(JNIEnv *env,
                                 jint index,
                                 jobject callback,
...
void AllocateBufferCallback(JNIEnv *env,
                            jint index,
                            jobject callback,
